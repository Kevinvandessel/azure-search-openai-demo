...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching information from documents."
...
class EmployeeInfoTool(CsvLookupTool):
    ...
    def __init__(self, employee_name: str):
        super().__init__(filename = "data/employeeinfo.csv", key_field = "name", name = "Employee", description = "useful for answering questions about the documentation.")
